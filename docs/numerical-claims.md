...
| NC-021 | Full test-suite size | 203 | `python -m pytest tests/ --collect-only -q -o addopts=""` (tail line), run at `6be4118` on `mert/calibration-yield-issue-45` | 2026-08-30 | Was `149` at `981f324`, then `166` at `1873625` · +37 on this branch: 2 regression tests for #46/#45, 2 for the historical-response guard, 22 for the probe (verdict table, sweep, retries, `main` exit codes), 11 for the canonical digest · see Rule 6 · cite this row in verification runbooks rather than recalling a count, and state the commit it was measured at |
