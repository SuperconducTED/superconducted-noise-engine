...
| NC-032 | Current pipeline-health backfill | 537 distinct states from 936 documents; 42.6% duplication | Generated `health/metrics.json` over `calibration-data` @ `46f93c8`, local run 2026-09-05 | 2026-09-05 | Candidate floors remain configuration, not a determination of training sufficiency; README and generated health artifacts are committed locally at `d7bdcd0` on `local/calibration-data-health`, not pushed |
