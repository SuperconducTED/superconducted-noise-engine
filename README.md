...
<!-- DASHBOARD:START -->
<!-- Generated by generate.py at 2026-09-17 14:47 UTC. Do not edit inside these markers. -->

**13 days** to 2026-09-30 · **12/28 gates met** · 8 ready · 4 in review · 4 blocked

Calendar 54% burned against 43% of gates met: **11 points behind the calendar**. Read at `125b7962` on `main`.

| | Milestone | Target | Gates |
| --- | --- | --- | ---: |
| 🟡 | **M0** Queue clear | 2026-09-05 (12d overdue) | 7/8 |
| 🟡 | **M1** Contracts and instruments | 2026-09-11 (6d overdue) | 3/5 |
