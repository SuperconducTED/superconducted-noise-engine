...
<!-- DASHBOARD:START -->
<!-- Generated by generate.py at 2026-09-11 05:41 UTC. Do not edit inside these markers. -->

**19 days** to 2026-09-30 · **9/28 gates met** · 10 ready · 3 in review · 5 blocked

Calendar 32% burned against 32% of gates met: level with the calendar. Read at `75dfdae3` on `main`.

| | Milestone | Target | Gates |
| --- | --- | --- | ---: |
| 🟡 | **M0** Queue clear | 2026-09-05 (6d overdue) | 7/8 |
| 🟡 | **M1** Contracts and instruments | 2026-09-11 | 1/5 |
| 🟡 | **M2** First measurements | 2026-09-18 | 1/5 |
...
| Baha Jarad | Unstick PR #94 for #48: Pipeline-health dashboard | No approving review yet: main's ruleset requires one. |

**Since 2026-09-10:** +1 milestone gate (8 to 9 of 28); M2 0/5 to 1/5; #48 Pipeline-health dashboard: ready to start to in review; #49 Scheduled backfill sweep: in review to closed; main moved to 75dfdae3.
