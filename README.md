...
<!-- DASHBOARD:START -->
<!-- Generated by generate.py at 2026-09-08 19:03 UTC. Do not edit inside these markers. -->

**22 days** to 2026-09-30 · **6/28 gates met** · 11 ready · 5 in review · 5 blocked

Calendar 21% burned against 21% of gates met: level with the calendar. Read at `645b4d1a` on `main`.

| | Milestone | Target | Gates |
| --- | --- | --- | ---: |
| 🟡 | **M0** Queue clear | 2026-09-05 (3d overdue) | 5/8 |
...
| Burak Öztekin | Re-review PR #68 (#59: Manual MF parameterization from the archive) | Your CHANGES_REQUESTED from 2026-09-08 is the standing block. main's ruleset does not dismiss it on push, so only you can clear it. |
...
| Baha Jarad | Unstick PR #70 for #48: Pipeline-health dashboard | Conflicts with main: needs a rebase before it can merge, and ci.yml will not re-run until it is clean. |

**Day by day:** 1 record so far. The routine adds one per day.
