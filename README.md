...
<!-- DASHBOARD:START -->
<!-- Generated by generate.py at 2026-09-14 05:41 UTC. Do not edit inside these markers. -->

**16 days** to 2026-09-30 · **10/28 gates met** · 10 ready · 3 in review · 4 blocked

Calendar 43% burned against 36% of gates met: **7 points behind the calendar**. Read at `004e14ed` on `main`.

| | Milestone | Target | Gates |
| --- | --- | --- | ---: |
| 🟡 | **M0** Queue clear | 2026-09-05 (9d overdue) | 7/8 |
| 🟡 | **M1** Contracts and instruments | 2026-09-11 (3d overdue) | 1/5 |
