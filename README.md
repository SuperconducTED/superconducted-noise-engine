...
<!-- DASHBOARD:START -->
<!-- Generated by generate.py at 2026-09-10 08:15 UTC. Do not edit inside these markers. -->

**20 days** to 2026-09-30 · **8/28 gates met** · 11 ready · 3 in review · 5 blocked

Calendar 29% burned against 29% of gates met: level with the calendar. Read at `d0d0b073` on `main`.
...
| Baha Jarad | Start #48: Pipeline-health dashboard | Its prerequisite merged 2026-09-02 and #63 cannot start its FR-1 half until the digest body is settled. |

**Since 2026-09-09:** +1 milestone gate (7 to 8 of 28); M0 6/8 to 7/8; #45 Polling cadence no longer limits the dataset: ready to start to closed; #48 Pipeline-health dashboard: in review to ready to start; #49 Scheduled backfill sweep: ready to start to in review; main moved to d0d0b073.
