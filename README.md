...
<!-- DASHBOARD:START -->
<!-- Generated by generate.py at 2026-09-13 13:17 UTC. Do not edit inside these markers. -->

**17 days** to 2026-09-30 · **10/28 gates met** · 10 ready · 3 in review · 4 blocked

Calendar 39% burned against 36% of gates met: **3 points behind the calendar**. Read at `004e14ed` on `main`.

| | Milestone | Target | Gates |
| --- | --- | --- | ---: |
| 🟡 | **M0** Queue clear | 2026-09-05 (8d overdue) | 7/8 |
| 🟡 | **M1** Contracts and instruments | 2026-09-11 (2d overdue) | 1/5 |
...
**Since 2026-09-12:** #73 Filter noise by physical gate semantics: ready to start to in review.
