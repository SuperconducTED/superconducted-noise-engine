...
<!-- DASHBOARD:START -->
<!-- Generated by generate.py at 2026-09-12 05:41 UTC. Do not edit inside these markers. -->

**18 days** to 2026-09-30 · **10/28 gates met** · 11 ready · 2 in review · 4 blocked

Calendar 36% burned against 36% of gates met: level with the calendar. Read at `004e14ed` on `main`.

| | Milestone | Target | Gates |
| --- | --- | --- | ---: |
| 🟡 | **M0** Queue clear | 2026-09-05 (7d overdue) | 7/8 |
| 🟡 | **M1** Contracts and instruments | 2026-09-11 (1d overdue) | 1/5 |
| 🟡 | **M2** First measurements | 2026-09-18 | 2/5 |
...
| Baha Jarad | Start #63: Training-set builder (training/dataset.py) | The reader-and-dedup half has no hard dependency the plan recognises and W2 is where it starts; #60's first archive fit is waiting on it. |

**Since 2026-09-11:** +1 milestone gate (9 to 10 of 28); M2 1/5 to 2/5; #48 Pipeline-health dashboard: in review to closed; #63 Training-set builder (training/dataset.py): blocked upstream to ready to start; main moved to 004e14ed.
